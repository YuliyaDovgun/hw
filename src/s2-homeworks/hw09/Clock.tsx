...
function Clock() {
    ...
    const stringDate = new Intl.DateTimeFormat('ru', { year: "numeric", month: "numeric", day: "numeric"}).format(date) || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
